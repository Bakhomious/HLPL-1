// Based on the calculator discussed in the lab, videos and the book
// Added pi, e to be predefined

// Not sure about the decleration change, primary won't accept names unless specified to do so. 
